...
class TestCategoryModel:
    ...
    def test_category_creation_valid(self, sample_category: Category):
        ...
        assert (
            sample_category.description == "Electronic devices and accessories"
        )
    ...
    def test_category_creation_minimal(
    ...
    def test_category_creation_with_null_description(
        self, category_builder: CategoryBuilder
    ):
    ...
    def test_category_name_too_long(self, category_builder: CategoryBuilder):
        ...
        with pytest.raises(ValidationError):
            (category_builder.with_name(too_long_name).build())
    ...
    def test_category_soft_delete(self, sample_category: Category):
        ...
        assert (
            Category.all_objects.filter(
                id=original_id, deleted_at__isnull=False
            ).exists()
            is True
        )
...
class TestProductModel:
    ...
    def test_product_creation_valid(
        self, sample_product: Product, sample_category: Category
    ):
    ...
    def test_product_creation_minimal(
        self, product_builder: ProductBuilder, sample_category: Category
    ):
    ...
    def test_product_price_max_digits(
        self, product_builder: ProductBuilder, sample_category: Category
    ):
        ...
        with pytest.raises(ValidationError):
            (
                ...
                .with_price(Decimal("12345678901.23"))
                .build()
            )

    def test_product_price_decimal_places(
        self, product_builder: ProductBuilder, sample_category: Category
    ):
    ...
    def test_product_category_required(self, product_builder: ProductBuilder):
        ...
        with pytest.raises(ValueError):
            product_builder.with_name("No Category Product").with_price(
                Decimal("10.00")
            ).build()

    def test_product_cascade_delete_category(
        self, sample_product: Product, sample_category: Category
    ):
...
class TestStoreModel:
    ...
    def test_store_creation_valid(
        self, sample_store: Store, regular_user: User
    ):
    ...
    def test_store_creation_minimal(
        self, store_builder: StoreBuilder, regular_user: User
    ):
    ...
    def test_store_name_max_length(
        self, store_builder: StoreBuilder, regular_user: User
    ):
    ...
    def test_store_cascade_delete_owner(
        self, sample_store: Store, regular_user: User
    ):
...
class TestStoreProductRelationModel:
    ...
    def test_store_product_relation_cascade_delete_product(
        ...
        assert (
            StoreProductRelation.objects.filter(id=relation_id).exists()
            is False
        )

    def test_store_product_relation_cascade_delete_store(
        self, store_product_relation: StoreProductRelation, sample_store: Store
    ):
    ...
    def test_store_product_relation_soft_delete(
        self, store_product_relation: StoreProductRelation
    ):
        """Test soft delete functionality."""
        ...
        assert (
            StoreProductRelation.all_objects.filter(
                id=original_id, deleted_at__isnull=False
            ).exists()
            is True
        )
...
class TestProductValidator:
    ...
    def test_validate_product_price_negative(
        self, product_validator: ProductValidator
    ):
    ...
    def test_validate_product_price_none(
        self, product_validator: ProductValidator
    ):
    ...
    def test_validate_store_name_too_long(
        self, product_validator: ProductValidator
    ):
    ...
    def test_validate_store_product_quantity_valid(
        self, product_validator: ProductValidator
    ):
        ...
        for quantity in test_cases:
            is_valid, error = (
                product_validator.validate_store_product_quantity(quantity)
            )
            assert is_valid is True
            assert error is None

    def test_validate_store_product_quantity_negative(
        self, product_validator: ProductValidator
    ):
    ...
    def test_validate_store_product_quantity_none(
        self, product_validator: ProductValidator
    ):
...
class TestProductModelRelationships:
    ...
    def test_store_owner_relationship(
        self, sample_store: Store, regular_user: User
    ):
    ...
    def test_store_product_relation_backwards_queries(
        ...
        assert (
            ...
            in sample_store.storeproductrelation_set.all()
        )

        # Query from product
        assert (
            store_product_relation
            in sample_product.storeproductrelation_set.all()
        )
    ...
    def test_multiple_stores_same_product(
        ...
        assert (
            StoreProductRelation.objects.filter(product=sample_product).count()
            == 2
        )
    ...
    def test_multiple_products_same_store(
        ...
        assert (
            StoreProductRelation.objects.filter(store=sample_store).count()
            == 2
        )
